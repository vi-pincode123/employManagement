...
public class EditServlet extends HttpServlet{
	public void service(HttpServletRequest request,HttpServletResponse response) throws IOException {
		...
		out.print("<center><form action='update' method='post' style='font-size:40px'><label>ID</label><br>"
				+ "<input type='hidden' value=''><br><label>NAME</label><br><input type='text'  value=''><br>"
				+ "<label>GENDER</label><br><input type='radio' name='gender'>male<input type='radio' name='gender'>female<br>"
